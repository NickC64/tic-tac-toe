...
export default function Game() {
  ...
  useEffect(() => {
    ...
    if (activePlayerConfig?.type === 'bot' && activePlayerConfig?.strategy) {
      ...
      eventBus.emit(GameEvents.BOT_THINKING, { player: activePlayer, name: activePlayerConfig.name });
      ...
      const timer = setTimeout(() => {
        ...
        if (botMove) {
          // Emit bot move event
          eventBus.emit(GameEvents.BOT_MOVE, { player: activePlayer, square: botMove });
